      ...
      <Grid container spacing={3} sx={{ mt: 2 }}>
        ...
        <Grid item xs={4}>
          <Box sx={{ p: 3, bgcolor: 'white', borderRadius: 2, height: '100%' }}>
            ...
            <Typography variant="body2">
              Share thousands of casino games with your audience using our customized linking tools.
            </Typography>
          </Box>
        </Grid>
        <Grid item xs={4}>
          <Box sx={{ p: 3, bgcolor: 'white', borderRadius: 2, height: '100%' }}>
            ...
            <Typography variant="body2">
              Earn up to 40% commission on player deposits and sign-ups with our competitive rates.
            </Typography>
          </Box>
        </Grid>
      </Grid>
